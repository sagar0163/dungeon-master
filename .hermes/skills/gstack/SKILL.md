...
- `references/project-gstack-setup.md` — Patterns for making gstack available in a project (global, submodule, vendored, team mode). Includes Nebula Writer 2 current state assessment.
